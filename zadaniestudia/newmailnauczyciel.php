...
if((isset($_SESSION['zalogowany'])) && ($_SESSION['zalogowany']==true))
{
    ...
    {
        header('Location: newmailadmin.php');
    }
...
if(isset($_POST['wyslij']))
{
    ...
    {   require_once "connect.php";
        ...
        if(isset($_POST['wszyscy'])){
            ...
            echo '<p><a href="newmailnauczyciel.php"><b>Powrót</b></a></p>';
...
<form action="newmailnauczyciel.php" method="post">
...
<br/>
<br/>
<a href="panelnauczyciela.php">Powrót!</a>
